<h2><a href="https://www.geeksforgeeks.org/problems/rotate-matrix-elements-clockwise2336/1">Rotate matrix elements clockwise</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given two integers M, N, and a 2D matrix Mat of dimensions MxN, clockwise rotate the elements in it.</span></p>
...
<p><br><span style="font-size: 18px;"><strong>Constraints:</strong><br>1&lt;=M,N,Mat[i][j]&lt;=1000</span></p></div><p><span style=font-size:18px><strong>Company Tags : </strong><br><code>Amazon</code>&nbsp;<br><p><span style=font-size:18px><strong>Topic Tags : </strong><br><code>Matrix</code>&nbsp;<code>Data Structures</code>&nbsp;
<h2><a href="https://www.geeksforgeeks.org/problems/heap-sort/1?page=1&sprint=ca8ae412173dbd8346c26a0295d098fd&sortBy=submissions">Heap Sort</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array&nbsp;<strong>arr[]</strong>. The task is to sort the array elements by Heap Sort.</span></p>

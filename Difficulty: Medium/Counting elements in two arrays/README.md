<h2><a href="https://www.geeksforgeeks.org/problems/counting-elements-in-two-arrays/1?_gl=1*f3s68c*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjwpf7CBhCfARIsANIETVr0Fz7dJ8gjQgK4XPxY_92grwUWNkzq4Jo3nTKQMAAZZsK4TrEGX5MaApP9EALw_wcB&gbraid=0AAAAAC9yBkCwGXwICDUfMrOd7AonIjM11">Counting elements in two arrays</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">You are given two unsorted arrays <strong>a[]</strong> and <strong>b[]</strong>. Both arrays may contain duplicate elements. For each element in <strong><code>a[]</code></strong>, your task is to count how many elements in <strong><code>b[]</code></strong> are <strong>less than or equal</strong> to that element.</span></p>

<h2><a href="https://www.geeksforgeeks.org/problems/sum-of-all-substrings-of-a-number-1587115621/1?_gl=1*1klnb4p*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjwucDBBhDxARIsANqFdr3GcjpDK8Mt6bvC_p8oLilq8S0jP925zh-06iOQ-rMTsc-TJkNr0K4aAuN_EALw_wcB&gbraid=0AAAAAC9yBkBKJIYKliyykZS16oqxd9Q0q">Sum of all substrings of a number</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an integer <strong>s</strong> represented as a string, the task is to get the sum of all possible sub-strings of this string.<br></span></p>
